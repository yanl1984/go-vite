...
func GetQuotaRatioForS(db QuotaRatioDb, toAddr types.Address) (uint8, error) {
...
func GetQuotaRatioForRS(db QuotaRatioDb, toAddr types.Address, sendBlock *ledger.AccountBlock, status GlobalStatus) (uint8, error) {
	if !types.IsContractAddr(toAddr) {
		return CommonQuotaRatio, nil
	}
...
func getQuotaRatioBySnapshotBlock(db QuotaRatioDb, toAddr types.Address, snapshotBlock *ledger.SnapshotBlock) (uint8, error) {
